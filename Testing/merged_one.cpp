...
vector<int> combine_50pr(vector<int> l, vector<int> r)                                   ///combine
{
...
vector<int> combine_single_point(vector<int> l, vector<int> r)                                   ///combine
{
    vector<int> res; //the permutation-child of the parents l and r
...
{
    int end_result = solve_50pr();
    end_result = min(end_result, solve_single_point());
    end_result = min(end_result, solve_single_point_our());
    av_rd += end_result;
}
